<template>
    <div class="main">
        <!-- 会员专区部分 -->
        <el-card style="width:1200px" class="memberCard">
            <div class="members">
                <div class="members-top">会员专区</div>
                ...
                <div class="members-bottom">
                    <div class="userInfo">
                        ...
                        <div class="viaInfo">
                            ...
                            <span class="grade"><i>Lv.1</i></span>
                            <p>会员登录尊享10大特权</p>
                        </div>
                    ...
                    <div class="intro">
                        <div class="video">
                            ...
                            <div class="videoInfo">
                                ...
                                <p>以下<i>723</i>个会员专区课程</p>
                                <router-link to="/center/mymember" class="studyFree">
                                    <p>全部免费学习</p>
                                </router-link>
                        ...
                        <div class="discounts">
                            ...
                            <div class="discountInfo">
                                ...
                                <p class="discountInfos">可获会员立减优惠</p>
                            </div>
                            <router-view></router-view>
                        </div>
                        <!-- 登录后 -->
                        <div class="to-vip">
                            <button class="to-vip-btn">
                                <router-link to="/center/mymember" class="vip-text"><span>立即开通</span></router-link>
                            </button>
                            <router-link to="/center/mymember" class="vip-bottom"><span>查看/开通></span></router-link>
        ...
        <el-card class="tagCard">
            <div class="selectCenter">
                <div class="selectContainer" :class="{fold:isFold}">
                    <el-row class="selectList" v-for="(item,index) in tagListStore.tagList" :key="index">
                ...
                <div class="priceup">
                    <el-dropdown placement="bottom">
                        <span class="el-dropdown-link">
                            价格<el-icon class="el-icon--right">
                                <ArrowDown />
                            </el-icon>
                        </span>
                        <template #dropdown>
        ...
        <div class="card_content_wrapper">
            <div class="loadMoreList">
                <div class="content_card_item" v-for="(videoModule,index) in tagListStore.videoModuled" :key="index">
                    <!-- 视频内容 -->
                    <div class="card_item">
                        <!-- 视频图片 -->
                        <div class="card-top">
...
import { reqLiveClassData } from '../../../api/course/course';
...
const More = async () => {
    ...
    result.data.content.forEach((item:any) => {
        tagListStore.videoModuled.push()
    })
    console.log(result)
...
const tagHandler = async (dances:any, dancesList:any) => {
    ...
    let res = await reqLiveClassData();
    res.data.content.forEach((item:any) => {
        tagListStore.videoModuled.splice(0, '', item)
    })
}

// 重置按钮点击回调
const resetHandler = () => {
    tagListStore.tagList.forEach((item:any) => {
        item.choises.forEach((dance:any) => {
            dance.isClick = false;
        })
    })
    tagListStore.getVideoModules();
}
